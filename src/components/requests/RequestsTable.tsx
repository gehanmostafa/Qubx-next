...
//   string,
//   { base: string; text: string; border: string; hoverRow: string }
// > = {
//   "Awaiting DICOM Upload": {
//     base: "bg-slate-100",
//     text: "text-slate-800",
//     border: "border border-slate-300",
//     hoverRow: "hover:bg-slate-200",
//   },
//   "Pending Payment": {
//     base: "bg-yellow-100",
//     text: "text-yellow-800",
//     border: "border border-yellow-300",
//     hoverRow: "hover:bg-yellow-200",
//   },
//   "DICOM Review": {
//     base: "bg-orange-100",
//     text: "text-orange-800",
//     border: "border border-orange-300",
//     hoverRow: "hover:bg-orange-200",
//   },
//   "In Progress": {
//     base: "bg-blue-100",
//     text: "text-blue-800",
//     border: "border border-blue-300",
//     hoverRow: "hover:bg-blue-200",
//   },
//   Delivered: {
//     base: "bg-green-100",
//     text: "text-green-800",
//     border: "border border-green-300",
//     hoverRow: "hover:bg-green-200",
//   },
//   "Reupload DICOM": {
//     base: "bg-red-100",
//     text: "text-red-800",
//     border: "border border-red-300",
//     hoverRow: "hover:bg-red-200",
//   },
// };
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between mb-2 items-center">
        <p className="font-semibold text-2xl ">Case Dashboard</p>
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <div>
                  <p className="font-semibold text-[16px]">{item.service?.name || "-"}</p>
                  <p className="text-sm text-gray-500">{item.anatomy?.name || "-"}</p>
                </div>
                <p className="text-sm font-medium text-gray-400">#{item.id}</p>
              </div>
              ...
              <div className="mt-4 flex justify-between items-center">
                <p className="text-xs text-gray-500">
                  {new Date(item.updatedAtStatus || item.created_at).toLocaleDateString()}
                </p>

                {statusName === "Pending Payment" ? (
                  <Button className="bg-[#1565C0] hover:bg-[#0D47A1] text-white px-4 py-1 text-sm rounded-full flex items-center gap-2">
                    <FaPaypal /> Pay 20$
                  </Button>
                ) : statusName === "Awaiting DICOM Upload" ? (
                  <Button className="bg-[#E65100] hover:bg-[#BF360C] text-white px-4 py-1 text-sm rounded-full flex items-center gap-2">
                    <Upload /> Upload
                  </Button>
                ) : statusName === "DICOM Review" ? (
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button className="bg-[#2E7D32] hover:bg-[#1B5E20] text-white px-3 py-1 text-sm rounded-full flex items-center gap-1">
                      <Download />
                    </Button>
                  </div>
                ) : statusName === "Reupload DICOM" ? (
                  <Button className="bg-[#C62828] hover:bg-[#B71C1C] text-white px-4 py-1 text-sm rounded-full">
                    Reupload
                  </Button>
                ) : (
                  "—"
